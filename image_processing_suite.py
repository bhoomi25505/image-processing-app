...
def main():
    ...
    if uploaded_file is not None:
        try:
            ...
            if st.session_state.original_img is None or uploaded_file.name != st.session_state.uploaded_file_name:
                ...
                st.toast(f"Image '{uploaded_file.name}' loaded successfully!", icon='🖼️')
            ...
            if st.session_state.current_img is not None:
                ...
                # Reset button
                if st.sidebar.button("🔄 Reset Image to Original", type="primary"):
                    st.session_state.current_img = st.session_state.original_img.copy()
                    st.toast("Image reset!", icon='✅')
    ...
    if st.session_state.current_img is not None:
        ...
        with col_tools:
            ...
            if st.button("🔍 Find Objects (Contours)"):
        ...
        with col3:
            ...
            if st.button("🖼️ Make 3 x 5 Grid"):
